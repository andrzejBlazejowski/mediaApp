...
export default function Page() {
  ...
  const rawData = api.articleScreen.all.useQuery({ sort, filter });
  const deleteRow = api.articleScreen.delete.useMutation();
  const invalidate = utils.articleScreen.all.invalidate;
