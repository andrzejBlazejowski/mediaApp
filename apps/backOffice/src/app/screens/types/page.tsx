...
export default function Page() {
  ...
  const rawData = api.screenType.all.useQuery({ sort, filter });
  useRedirectOnUnauthorized(rawData);
  const deleteRow = api.screenType.delete.useMutation();
  const invalidate = utils.screenType.all.invalidate;
