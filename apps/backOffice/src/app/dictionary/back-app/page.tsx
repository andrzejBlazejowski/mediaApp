...
export default function Page() {
  ...
  const rawData = api.backOfficeDictionary.all.useQuery({ sort, filter });
  const deleteRow = api.backOfficeDictionary.delete.useMutation();
  const invalidate = utils.backOfficeDictionary.all.invalidate;
