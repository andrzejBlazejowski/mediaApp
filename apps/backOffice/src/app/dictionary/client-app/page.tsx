...
export default function Page() {
  ...
  const rawData = api.clientAppDictionary.all.useQuery({ sort, filter });
  const deleteRow = api.clientAppDictionary.delete.useMutation();
  const invalidate = utils.clientAppDictionary.all.invalidate;
