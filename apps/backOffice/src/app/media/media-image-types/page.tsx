...
export default function Page() {
  ...
  const rawData = api.mediaImageType.all.useQuery({ sort, filter });
  const deleteRow = api.mediaImageType.delete.useMutation();
  const invalidate = utils.mediaImageType.all.invalidate;
