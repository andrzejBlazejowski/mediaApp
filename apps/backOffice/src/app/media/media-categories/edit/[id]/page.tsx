...
export default function Page() {
  ...
  const schema = media.mediaCategoriesInsertSchema;
  const route = api.mediaCategory;
  const util = utils.mediaCategory;
  ...
  return (
    ...
    >
      <>
        <MediaLookup invalidate={invalidate} mainKey={mainKey} id={id} />
      </>
    </FormView>
  );
}
