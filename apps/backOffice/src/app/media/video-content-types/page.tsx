...
export default function Page() {
  ...
  const rawData = api.videoContentType.all.useQuery({ sort, filter });
  const deleteRow = api.videoContentType.delete.useMutation();
  const invalidate = utils.videoContentType.all.invalidate;
