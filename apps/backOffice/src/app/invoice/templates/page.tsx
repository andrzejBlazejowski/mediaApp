...
export default function Page() {
  ...
  const rawData = api.invoiceTemplate.all.useQuery({ sort, filter });
  const deleteRow = api.invoiceTemplate.delete.useMutation();
  const invalidate = utils.invoiceTemplate.all.invalidate;
