...
export default function Page() {
  ...
  const rawData = api.brandingImageType.all.useQuery({ sort, filter });
  const deleteRow = api.brandingImageType.delete.useMutation();
  const invalidate = utils.brandingImageType.all.invalidate;
