...
export default function Page() {
  ...
  const rawData = api.brandingColorType.all.useQuery({ sort, filter });
  const deleteRow = api.brandingColorType.delete.useMutation();
  const invalidate = utils.brandingColorType.all.invalidate;
